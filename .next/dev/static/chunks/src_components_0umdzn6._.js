...
;
;
function GameGrid({ games, title }) {
    _s();
    const [query, setQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const filtered = query ? games.filter((g)=>g.name.toLowerCase().includes(query.toLowerCase())) : games;
...
_s(GameGrid, "qO/HZodsWTfJhuzZtdaxiosei2U=");
_c = GameGrid;
var _c;
...
//# sourceMappingURL=src_components_0umdzn6._.js.map